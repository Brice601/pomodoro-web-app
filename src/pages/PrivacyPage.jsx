...
const PrivacyPage = () => {
  return (
    <div className="py-12">
      <Seo
        title="Politique de confidentialité | Architecte IA"
        description="Traitement des données personnelles, cookies et mesure d'audience sur le site Architecte IA."
        path="/privacy"
      />
